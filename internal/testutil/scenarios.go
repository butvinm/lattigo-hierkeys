...
// Lattigo's gadget decomposition is count-based: dnum = ceil(QCount/PCount), each digit holds PCount consecutive Q primes regardless of size.
...
type Scenario struct {
	...
	// LogPHK3 primes are P^(1) at Levels[1];
	// LogPExtra primes are P^(2) at Levels[2] (top).
